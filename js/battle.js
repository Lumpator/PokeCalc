...
const Battle = {
    ...
    playMusic() {
        if (!this.battleMusic) {
            this.battleMusic = new Audio(
                "sounds/Pokemon_DiamondPearlPlatinum_-_Battle_Trainer_Music_HQ_KLICKAUD.mp3",
            );
    ...
    nextQuestion() {
        ...
        // Update UI
        document.getElementById("battle-question").textContent =
            `${a} × ${b} = ?`;
